...
# verification for the ghcr.io/isaiahaguilera/eaglesnest-os repository using sigstore signatures.
#
# What this does:
# - Enforces signature verification for ghcr.io/isaiahaguilera/eaglesnest-os
# - Uses the public key at /etc/pki/containers/eaglesnest-os.pub
...
PUBLIC_KEY_PATH="/etc/pki/containers/eaglesnest-os.pub"
IMAGE_REFERENCE="ghcr.io/isaiahaguilera/eaglesnest-os"
